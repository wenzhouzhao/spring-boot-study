...
@Component
public class QueueThreeConsumer {
    ...
    public void directHandlerAutoAck(MessageStructPO message) {
        log.info("队列3消费者，队列名：{}，接收消息：{}", RabbitConstants.QUEUE_THREE, JSONUtil.toJsonStr(message));
    }
    ...
    public void directHandlerManualAck(MessageStructPO messageStruct, Message message, Channel channel) {
        ...
        try {
            log.info("队列3，手动ACK，队列名：{}，接收消息：{}", RabbitConstants.QUEUE_THREE, JSONUtil.toJsonStr(messageStruct));
